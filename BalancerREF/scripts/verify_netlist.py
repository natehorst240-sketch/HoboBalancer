"""Independent schematic requirements checked against KiCad's exported netlist (Rev C)."""
...
groups={
'3V3':'U1.3 U2.8 U2.5 U3.8 U4.5 U6.1 U6.10 U8.8 U9.5 U10.8 U10.3 J4.1 PD1.1 TP1.1 C6.1 C7.1 C8.1 C9.1 C13.1 C14.1 C15.1 C16.1 C17.1 C24.1 C25.1 C27.1 C29.1 R4.1 R5.1 R8.1 R9.1 R15.1 R16.1 R24.1 R26.1 R30.1',
...
'SYS_SW':'R11.1 R18.1 SW1.2 U6.5 U6.8 U6.6 U6.7 C4.1 C5.1 C20.1',
'EN':'U1.45 R4.2 C10.1 SW4.2 TP13.1',
'BOOT':'U1.4 R5.2 R9.2 SW3.2 TP14.1',
...
'PROG':'U5.5 R3.1','SWITCH_L1':'U6.4 L1.1','SWITCH_L2':'U6.2 L1.2',
'MAG+':'J3.1 TP5.1 R13.2','MAG_SERIES':'R13.1 R14.2','VR_IN':'U3.3 R14.1',
'PEAK':'U3.7 R17.1 C19.1','TIMING':'U3.14 R16.2 C18.1',
'LED_A':'R18.2 D1.2','LED_K':'D1.1 Q1.3','MOS_GATE':'R19.1 R20.1 Q1.1',
...
grounds='U1.1 U1.2 U1.42 U1.43 '+' '.join('U1.'+str(i) for i in range(46,66))+' U2.2 U2.3 U2.6 U2.7 U3.2 U3.9 U3.11 U4.2 U5.2 U6.3 U6.9 U6.11 U7.2 U8.4 U9.3 U10.1 U10.4 J1.A1 J1.A12 J1.B1 J1.B12 J1.SH J2.2 J3.2 J4.2 TP2.1 TP6.1 Q1.2 Q4.1 LED1.1 D3.1 R1.1 R2.1 R3.2 R12.2 R17.2 R20.2 R25.2 R27.2 R31.2 SW2.1 SW3.1 SW4.1 '+' '.join('C'+str(i)+'.2' for i in list(range(1,21))+[23,24,25,26,27,29,30])
groups['GND']=grounds
...
'U4':{'1':'OUT','2':'VCC-','3':'IN+','4':'IN-','5':'VCC+'},
'U5':{'1':'STAT','2':'VSS','3':'VBAT','4':'VDD','5':'PROG'},
...
# TLV9062 SOIC-8 standard dual op amp
'U8':{'1':'OUT1','2':'IN1-','3':'IN1+','4':'V-','5':'IN2+','6':'IN2-','7':'OUT2','8':'V+'},
# SN74LVC1G08 DBV
