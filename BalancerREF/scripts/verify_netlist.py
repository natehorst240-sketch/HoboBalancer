...
# TP4, TP5, TP6 and TP11-TP14 were dropped from the sheet in commit 58b622f (the
# placement regroup); only TP1/2/3/7/9/10 remain, and the expected nets follow the sheet.
groups={
...
# U7 is an SRV05-4: no internal I/O-to-I/O path, so both pads of each flow-through
# pair (1/6 for D-, 3/4 for D+) carry the same net and the trace joins them.
...
# R39 holds OPT_COMP low when the head cable is unplugged (Rev G).
'OPT_COMP':'J5.5 U9.1 R39.2',
...
grounds='U1.1 U1.2 U1.42 U1.43 '+' '.join('U1.'+str(i) for i in range(46,66))+' U2.2 U2.3 U2.6 U2.7 U3.2 U3.9 U3.11 U5.4 U5.8 U5.15 U5.17 U6.3 U6.9 U6.11 U7.2 U9.3 U10.4 J1.A1 J1.A12 J1.B1 J1.B12 J1.SH J2.2 J3.2 J4.2 J5.2 J5.4 J5.6 TP2.1 Q4.1 LED1.1 D3.2 R39.1 R1.1 R2.1 R3.2 R12.2 R17.2 R35.2 R36.2 SW2.1 SW3.1 '+' '.join('C'+str(i)+'.2' for i in list(range(1,20))+[26,27,29,30])
groups['GND']=grounds
