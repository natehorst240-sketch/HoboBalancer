...
Rev G (2026-09-19) corrected three review findings: D3's polarity, bias on both of U9's
inputs, and the USB pair routed through U7 rather than spurred off it. The same pass
dropped TP4, TP5, TP6, TP11, TP12, TP13 and TP14 from this spec - they left the sheet
...
# power-cycles the MCU. R4/C10 still hold EN high.
'EN':'U1.45 R4.2 C10.1',
# R5 removed: it duplicated R9's 10k pull-up on the same net.
'BOOT':'U1.4 R9.2 SW3.2',
...
# Each data line lands on two of the SRV05-4's four channels, on opposite sides of
# the package, so the pair routes THROUGH the array instead of spurring off it.
'USB_D-_CONNECTOR':'R6.1 J1.A7 J1.B7 U7.1 U7.6',
'USB_D+_CONNECTOR':'R7.1 J1.A6 J1.B6 U7.3 U7.4',
...
'MAG+':'J3.1 R13.2','MAG_SERIES':'R13.1 R14.2','VR_IN':'U3.3 R14.1',
...
# Rev G: R39 and R40 hold U9's two Schmitt inputs low when nothing is driving them -
# the head unplugged from J5, or GPIO13 still high-Z through the ESP32's boot.
'OPT_COMP':'J5.5 U9.1 R39.1',
'SYNC_DELAY':'R29.1 C26.1 U9.2 R40.1',
'SYNC_HIT':'U9.4 U10.1',
